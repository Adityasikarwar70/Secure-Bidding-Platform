...
import { fetchAllUnverifiedUser } from "../Service/ApproveUser";
...
const ApproveUser = () => {
  ...
  useEffect(() => {
    const getAllUnverifiedUser = async () => {
      try {
        const res = await fetchAllUnverifiedUser();
        setUnverifiedUser(res);
      } catch (error) {
        console.log(error);
      }
    };
  ...
  return (
    <div>
      <div className="p-4 overflow-visible">
        <h2 className="heading mb-5 fs-1">Verify User</h2>
