...
import { getAllAuctionByStatus } from '../Service/UpcommingAuction';
...
const UpcomingAuction = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      const auctions = await getAllAuctionByStatus(0);
  ...
  return (
     <div>
      <div className="p-4 overflow-visible">
        <h2 className="heading mb-5 fs-1">Upcoming Auction</h2>
